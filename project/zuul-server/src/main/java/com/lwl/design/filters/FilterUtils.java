 ...
 */
package com.lwl.design.filters;
...
public class FilterUtils {
    ...
    public static final String ROLE_ID          = "scd-role-id";
    ...
    public final String getRoleId(){
        RequestContext ctx = RequestContext.getCurrentContext();
        if (ctx.getRequest().getHeader(ROLE_ID) != null) {
            return ctx.getRequest().getHeader(ROLE_ID);
        } else {
            return ctx.getZuulRequestHeaders().get(ROLE_ID);
        }
    }

    public void setRoleId(String roleId){
        RequestContext ctx = RequestContext.getCurrentContext();
        ctx.addZuulRequestHeader(SHOP_ID, roleId);
    }
